          ...
          <div className="row pt-5">
            <div className="col-12 col-md-6 pb-3">
              <div className="footer-card1">
                ...
                <p className="footer-para">
                  <span className="fw-bold">LaslesVPN</span> is a private
                  ...
                  <div className="icon-card">
                    ...
                    >
                      <svg
                        ...
                        fill="currentColor"
                        className="bi bi-instagram face-icon"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div className="icon-card">
                    ...
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        className="bi bi-facebook face-icon"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div className="icon-card">
                    ...
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        className="bi bi-twitter face-icon"
                        viewBox="0 0 16 16"
                      >
            ...
            <div className="col-4 col-md-2 ">
              <div className="footer-card2">
                <h4 className="footer-card2-heading">Product</h4>
                <h5 className="heading-para">Download</h5>
                <h5 className="heading-para">Pricing</h5>
                <h5 className="heading-para">Locations</h5>
                <h5 className="heading-para">Server</h5>
                <h5 className="heading-para">Countries</h5>
                <h5 className="heading-para">Blog</h5>
              </div>
            </div>
            <div className="col-4 col-md-2">
              <div className="footer-card2">
